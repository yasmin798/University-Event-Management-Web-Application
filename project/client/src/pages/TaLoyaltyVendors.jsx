...
import StudentSidebar from "../components/TaSidebar";

function TaLoyaltyVendors() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        setLoading(true);
        // Show accepted by default; for testing, you may switch to 'all'
...
export default TaLoyaltyVendors;
